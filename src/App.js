          ...
          <div className="card bg-base-100 shadow-lg overflow-x-auto md:p-4 p-2 flex md:flex-row flex-col gap-2 justify-center">
            ...
            <div className='flex items-center w-full lg:gap-6 gap-2'>
              ...
              <button className="lg:btn-md btn btn-xs hover:text-info" onClick={() => { setTime(30)}}>
                <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.0} strokeLinecap="round" strokeLinejoin="round"><path d="M21.5 2v6h-6M2.5 22v-6h6M2 11.5a10 10 0 0 1 18.8-4.3M22 12.5a10 10 0 0 1-18.8 4.2"/></svg>
              </button>            </div>
            ...
            <div className='flex items-center w-full lg:gap-6 gap-2'>
              ...
              <button className="lg:btn-md btn btn-xs hover:text-info" onClick={() => { setSort("")}}>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" className="w-4 h-4" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.0} strokeLinecap="round" strokeLinejoin="round"><path d="M21.5 2v6h-6M2.5 22v-6h6M2 11.5a10 10 0 0 1 18.8-4.3M22 12.5a10 10 0 0 1-18.8 4.2"/></svg>
              </button>
            </div>
          </div>
          <DataTable data={db}/>
